...
struct TourData nearestAddition_TSP(double **distances, int numOfCoords, char *outputfile, int starting_coord) {
...
// Function to solve the TSP using Nearest addition method
//struct TourData nearestAddition(double **distances, int numOfCoords, char *outputfile, int starting_coord) {
//
//    int currentSize = 1;
//    int *tour = malloc((numOfCoords + 1) * sizeof(int));
//    bool *visited_nodes = malloc(numOfCoords * sizeof(bool));
